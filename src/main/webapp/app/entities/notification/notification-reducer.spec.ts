...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches SEARCH_NOTIFICATIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTIFICATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTIFICATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NOTIFICATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NOTIFICATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NOTIFICATION actions', async () => {
      const arg = 42666;
