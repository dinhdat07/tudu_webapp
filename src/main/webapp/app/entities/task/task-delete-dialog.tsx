...
import { deleteEntity, getEntity } from './task.reducer';
...
export const TaskDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/task${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="tuduApp.task.delete.question">
        <Translate contentKey="tuduApp.task.delete.question" interpolate={{ id: taskEntity.id }}>
