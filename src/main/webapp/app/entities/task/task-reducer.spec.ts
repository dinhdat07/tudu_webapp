...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TASK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_TASKS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TASK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TASK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TASK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TASK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TASK actions', async () => {
      const arg = 42666;
