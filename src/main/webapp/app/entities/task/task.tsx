...
import { getEntities, searchEntities } from './task.reducer';
  ...
  return (
    <div>
      <h2 id="task-heading" data-cy="TaskHeading">
        <Translate contentKey="tuduApp.task.home.title">Tasks</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="tuduApp.task.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/task/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="tuduApp.task.home.createLabel">Create new Task</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('tuduApp.task.home.search')}
                />
        ...
        {taskList && taskList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="tuduApp.task.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('title')}>
                  <Translate contentKey="tuduApp.task.title">Title</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('title')} />
                </th>
                ...
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="tuduApp.task.status">Status</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('status')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="tuduApp.task.home.notFound">No Tasks found</Translate>
            </div>
          )
        )}
      </div>
