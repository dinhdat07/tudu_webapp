...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERTASKS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_USERTASKS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERTASKS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERTASKS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERTASKS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERTASKS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERTASKS actions', async () => {
      const arg = 42666;
