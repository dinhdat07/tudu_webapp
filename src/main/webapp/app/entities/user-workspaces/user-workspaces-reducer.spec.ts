...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERWORKSPACES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_USERWORKSPACES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERWORKSPACES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERWORKSPACES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERWORKSPACES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERWORKSPACES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERWORKSPACES actions', async () => {
      const arg = 42666;
