...
import { getEntities, searchEntities } from './workspace.reducer';
  ...
  return (
    <div>
      <h2 id="workspace-heading" data-cy="WorkspaceHeading">
        <Translate contentKey="tuduApp.workspace.home.title">Workspaces</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="tuduApp.workspace.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/workspace/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="tuduApp.workspace.home.createLabel">Create new Workspace</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('tuduApp.workspace.home.search')}
                />
        ...
        {workspaceList && workspaceList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="tuduApp.workspace.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="tuduApp.workspace.name">Name</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('name')} />
                </th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/workspace/${workspace.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="tuduApp.workspace.home.notFound">No Workspaces found</Translate>
            </div>
          )
        )}
      </div>
