...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKSPACE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_WORKSPACES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WORKSPACE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WORKSPACE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WORKSPACE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WORKSPACE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WORKSPACE actions', async () => {
      const arg = 42666;
