...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            createCache(cm, me.tudu.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            createCache(cm, me.tudu.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            ...
            createCache(cm, me.tudu.domain.Task.class.getName() + ".users", jcacheConfiguration);
            createCache(cm, me.tudu.domain.Workspace.class.getName() + ".users", jcacheConfiguration);
