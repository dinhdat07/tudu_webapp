...
class NotificationResourceIT {
    ...
    public static Notification createEntity() {
        return new Notification().message(DEFAULT_MESSAGE).status(DEFAULT_STATUS).createdAt(DEFAULT_CREATED_AT);
    }
    ...
    public static Notification createUpdatedEntity() {
        return new Notification().message(UPDATED_MESSAGE).status(UPDATED_STATUS).createdAt(UPDATED_CREATED_AT);
    }
    ...
    void putExistingNotification() throws Exception {
        ...
        updatedNotification.message(UPDATED_MESSAGE).status(UPDATED_STATUS).createdAt(UPDATED_CREATED_AT);
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.message(UPDATED_MESSAGE).status(UPDATED_STATUS);
    ...
    void fullUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.message(UPDATED_MESSAGE).status(UPDATED_STATUS).createdAt(UPDATED_CREATED_AT);
